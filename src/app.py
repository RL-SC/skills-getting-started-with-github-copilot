...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the school soccer team for competitive matches and practices",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Swim Club": {
        "description": "Swim training, technique improvement, and local competitions",
    ...
    "Debate Team": {
        "description": "Build public speaking and argument skills through competitive debate",
        "schedule": "Tuesdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["amelia@mergington.edu", "ethan@mergington.edu"]
    },
    "Science Club": {
        "description": "Conduct experiments, explore science topics, and prepare for science fairs",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
